...
/usr/lib/qt6/bin/qmlformat "$plugin_dir/Bootstrap.qml" >/dev/null
bash -n "$runtime_dir/toggle.sh"
python3 -m py_compile "$runtime_dir/server.py" "$runtime_dir/state.py" "$plugin_dir/bin/localtypectl"
